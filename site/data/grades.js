var GRADES = [
  ...
  { g: 8,  name: 'Algebra + Geometry',     meta: 'Quarter I complete — 24 topics, 504 problems',        status: 'live' },
  { g: 9,  name: 'Algebra + Geometry',     meta: 'Quadratic functions · progressions · circles',        status: 'soon' },
  { g: 10, name: 'Algebra + Geometry',     meta: 'Trigonometry · powers and roots · solid geometry',    status: 'soon' },
  { g: 11, name: 'Algebra + Geometry',     meta: 'Derivatives · integrals · combinatorics',             status: 'soon' }
];
