#!/usr/bin/env python3
"""Build the Grade 10-11 workbook from the generated markdown plans.

Run after build-plans-10-11.py:  python3 build-xlsx-10-11.py
"""
import os, re
...
OUT = os.path.join(HERE, 'Grades10-11_Annual_Plans_2026-2027.xlsx')

SHEETS = [
    ('04-special-class-algebra-grade10.md',  'G10 Algebra 3h',
     'ANNUAL PLAN — ALGEBRA, GRADE 10 (SPECIAL CLASS)',
     '3 hours per week · 102 hours · Uzbekistan national programme enriched with Cambridge IGCSE Extended and AS Pure Mathematics 1'),
    ('05-special-class-geometry-grade10.md', 'G10 Geometry 2h',
     'ANNUAL PLAN — GEOMETRY, GRADE 10 (SPECIAL CLASS)',
     '2 hours per week · 68 hours · Uzbekistan national programme enriched with Cambridge IGCSE Extended and AS Pure Mathematics 1'),
    ('06-special-class-algebra-grade11.md',  'G11 Algebra 3h',
     'ANNUAL PLAN — ALGEBRA AND CALCULUS, GRADE 11 (SPECIAL CLASS)',
     '3 hours per week · 102 hours · Uzbekistan national programme enriched with Cambridge AS & A Level Pure Mathematics 1 and 2'),
    ('07-special-class-geometry-grade11.md', 'G11 Geometry 2h',
     'ANNUAL PLAN — GEOMETRY, GRADE 11 (SPECIAL CLASS)',
     '2 hours per week · 68 hours · Uzbekistan national programme enriched with Cambridge IGCSE Extended and A Level Pure Mathematics 2'),
]
